...
export default function NavBar(props) {
  ...
  <img src={web} width="100" width="100" className="img-fluid" />
    {/* <a className="navbar-brand" href="#">ASG Tech Solutions</a> */}
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0" style={{alignItems:"center"}}>
        ...
        {/* <li className="nav-item">
          <NavLink className="nav-link "  exact aria-current="page" activeClassName="currentPage" to="/trial">Trials</NavLink>
        </li> */}
        <li className="nav-item">
          <NavLink className="nav-link" exact aria-current="page" activeClassName="currentPage" to='/login'><strong style={{color:"0FAAE3"}}>In/Out</strong></NavLink>
        </li>  
      </ul> 
    </div>
  </div>
